...
class HIMO_3O(Dataset):
    def __init__(self,
                args,
                split='train'):
        super(HIMO_3O,self).__init__()
        self.args=args
        self.split=split
        self.data_path=osp.join(args.data_dir,'processed_3o',f'{split}.h5')
        self.obj_bps_path=osp.join(args.data_dir,'processed_3o','object_bps.npz')
        self.obj_sampled_verts_path=osp.join(args.data_dir,'processed_3o','sampled_obj_verts.npz')
    ...
    def __getitem__(self, idx):
        ...
        obj3_bps=self.object_bps[data['obj3_name']] # 1,1024,3
        ...
        obj3_sampled_verts=self.object_sampled_verts[data['obj3_name']] # 1024,3    

        init_state=x_start[0] # 52*3+52*6+3+3*9

        betas=data['betas'] # 10

        return text,obj1_bps,obj2_bps,obj3_bps,obj1_sampled_verts,obj2_sampled_verts,obj3_sampled_verts,init_state,x_start,m_len,betas
