...
from src.utils.parser_utils import train_net_3o_args
...
from src.dataset.himo_3o_dataset import HIMO_3O
from src.dataset.tensors import himo_3o_collate_fn

from torch.utils.data import DataLoader
from loguru import logger

def main():
    args=train_net_3o_args()
    # save path
    ...
    train_dataset=HIMO_3O(args,split='train')
    data_loader=DataLoader(train_dataset,batch_size=args.batch_size,
                           shuffle=True,num_workers=8,drop_last=True,collate_fn=himo_3o_collate_fn)
